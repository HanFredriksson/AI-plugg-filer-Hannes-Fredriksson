...
class Recommender():
    ...
    def pred_engagement_level(self):
        ...
        if os.path.exists(os.path.join(self.file_path, "pred_engagement_model.pkl")):
            with open(os.path.join(self.file_path, "pred_engagement_model.pkl"), "rb") as file:
            ...
            with open(os.path.join(self.file_path, "pred_engagement_model.pkl"), "wb") as file:
